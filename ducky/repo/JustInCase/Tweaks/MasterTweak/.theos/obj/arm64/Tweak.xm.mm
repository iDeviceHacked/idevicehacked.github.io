...
if ([self.title isEqualToString:[[NSBundle bundleWithPath:@"/System/Library/ControlCenter/Bundles/ConnectivityModule.bundle"] localizedStringForKey:@"CONTROL_CENTER_STATUS_BLUETOOTH_NAME" value:@"CONTROL_CENTER_STATUS_BLUETOOTH_NAME" table:@"Localizable"]]) {
	...
	}else {_logos_orig$_ungrouped$CCUILabeledRoundButton$buttonTapped$(self, _cmd, arg1);}
}
...
static MTLumaDodgePillView* _logos_method$_ungrouped$MTLumaDodgePillView$initWithFrame$(_LOGOS_SELF_TYPE_INIT MTLumaDodgePillView* __unused self, SEL __unused _cmd, struct CGRect arg1) _LOGOS_RETURN_RETAINED {
    if (hidehomebar){
        return _logos_orig$_ungrouped$MTLumaDodgePillView$initWithFrame$(self, _cmd, arg1);
        }else{
            return NULL;
        }
}
...
static __attribute__((constructor)) void _logosLocalCtor_b3856502(int __unused argc, char __unused **argv, char __unused **envp) {
