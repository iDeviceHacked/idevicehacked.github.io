...
@class SBDashBoardProudLockViewController; @class SBDashBoardTeachableMomentsContainerView; @class NCNotificationListSectionRevealHintView; @class SBDashBoardQuickActionsViewController; @class FBSystemService; @class _UINavigationBarLargeTitleViewLayout; @class SBMainDisplaySceneManager; @class UIKBRenderConfig; @class UIDevice; @class SBDashBoardComponent; @class SBFolderBackgroundView; @class PSBadgedTableCell; @class CCUIModuleSliderView; @class SBApplication; @class SpringBoard; @class SBFolderIconBackgroundView; 
