...
@class SCShazamAdditionalServicesViewController; @class SCContactsCTAFooterView; @class SCBottomBorderedView; @class SCFeedComponentView; @class SCSnapcodeServicesController; @class MobileSettingsViewController; @class SCLagunaSettingsViewController; @class QuickAddPrivacySettingsViewController; @class ChangePasswordReauthViewController; @class BirthdaySettingsViewController; @class TwoFADisabledSettingsViewController; @class SCStoriesViewHeader; @class UICollectionView; @class StoriesCell; @class SCTabBarView; @class SCAlertView; @class SCShapeView; @class SCRecipientBar; @class SCSettingsTableViewCell; @class ChangeDisplayNameViewController; @class TwoFASetupAuthViewController; @class SCMiniProfileView; @class SCCardBackgroundView; 
