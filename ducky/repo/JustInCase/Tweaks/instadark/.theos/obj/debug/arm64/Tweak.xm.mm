...
@class IGGroupedTableViewCell; @class IGDirectMessageReactionsView; @class IGExploreTopicSelectorView; @class UIImageView; @class IGFeedItemHeader; @class IGTabButton; @class UIStatusBarWindow; @class IGDirectTextMessageCell; @class UITableViewCellContentView; @class IGEndOfFeedDemarcatorCell; @class _UIBarBackground; @class IGDirectTextMessageBubbleView; @class IGNavigationBarBackgroundView; @class IGFeedItemTextCell; @class IGNewsCellView; @class IGCommentGroupCaptionContentView; @class IGDirectVisualMessageTombstoneCell; @class IGListHeaderView; @class IGDirectVideoMessageCell; @class IGLabel; @class IGDirectInboxThreadCell; @class IGProfilePictureImageView; @class _UIStatusBar; @class IGDirectSeenStateMessageCell; @class IGDirectRecipientCell; @class IGMediaThumbnailCell; @class IGCommentGroupTextContentWithLikeView; @class IGFeedItemUFICell; @class IGProfileAvatarStatsView; @class IGDirectToggleTableViewCell; @class IGCoreTextView; @class IGFeedItemInLineComposerCell; @class IGDirectPostMessageCell; @class IGUserListSelectableCollectionCell; @class IGUFIButton; @class IGExplorePageContainerCollectionViewCell; @class IGMainAppHeaderView; @class IGLabelSupplementaryView; @class IGTabBarButton; @class IGDirectSearchBar; @class IGTableViewCell; @class IGGroupedTableView; @class UICollectionView; @class IGUFIButtonBarView; @class IGDirectProfileMessageCell; @class IGNavSearchBar; @class IGDirectPhotoMessageCell; @class IGThreadInfoUserTableViewCell; @class UIStatusBar; 
